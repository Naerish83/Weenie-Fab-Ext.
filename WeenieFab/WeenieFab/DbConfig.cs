...
namespace WeenieFab
{
    public static class DbConfig
    {
        ...
        public static string ConnectionString { get; set; } =
            "server=127.0.0.1;port=3308;uid=root;pwd=root;database=ace_world;SslMode=None;Default Command Timeout=5;Connection Timeout=4;"; //YOU MUST CHANGE uid + pwd to match your setup
